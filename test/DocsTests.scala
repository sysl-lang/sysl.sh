...
class DocsTests extends AnyFreeSpec with DocsSupport with ParallelTestExecution {
  ...
  private val expected: Map[String, (Int, Int, Int)] = Map(
    ...
    "docs/content/reference/modules.md"                -> (13, 10, 7),
    ...
    "docs/content/reference/attributes.md"             -> (4, 13, 3),
    ...
    "docs/content/library/core.md"                     -> (21, 4, 10),
    ...
    "docs/content/library/time.md"                       -> (12, 3, 3),
