...
class DocsTests extends AnyFreeSpec with DocsSupport with ParallelTestExecution {
  ...
  private val expected: Map[String, (Int, Int, Int)] = Map(
    ...
    "docs/content/reference/declarations.md"          -> (19, 6, 1),
    "docs/content/reference/patterns.md"              -> (11, 12, 0),
    "docs/content/reference/memory.md"                -> (23, 16, 0),
    "docs/content/reference/arrays.md"                -> (19, 8, 1),
    ...
    "docs/content/reference/modules.md"                -> (15, 10, 7),
    ...
    "docs/content/reference/ffi.md"                    -> (13, 21, 8),
    "docs/content/reference/inline-assembly.md"        -> (3, 3, 6),
    "docs/content/reference/attributes.md"             -> (16, 20, 4),
