...
class DocsTests extends AnyFreeSpec with DocsSupport with ParallelTestExecution {
  ...
  private val expected: Map[String, (Int, Int, Int)] = Map(
    ...
    "docs/content/reference/patterns.md"              -> (10, 11, 0),
    ...
    "docs/content/reference/generics.md"              -> (13, 8, 0),
    "docs/content/reference/modules.md"                -> (13, 10, 4),
    ...
    "docs/content/reference/verification.md"           -> (13, 4, 1),
    ...
    "docs/content/guides/table.md"                     -> (2, 0, 3),
    "docs/content/library/core.md"                     -> (18, 4, 8),
    "docs/content/library/text.md"                      -> (16, 6, 5),
    ...
    "docs/content/library/math.md"                      -> (16, 9, 2),
