...
class DocsTests extends AnyFreeSpec with DocsSupport with ParallelTestExecution {
  ...
  private val expected: Map[String, (Int, Int, Int)] = Map(
    ...
    // Two more runnable and two more refusals: a property may belong to the type rather than to a
    ...
    // Four more runnable and two more refusals: a bound may be written after the signature with
    ...
    "docs/content/reference/generics.md"              -> (36, 19, 0),
...
// One more again: a `real` renders at the shortest precision that reads back equal, and the
    ...
    "docs/content/library/ring.md"                     -> (5, 1, 0),
    ...
    "docs/content/library/slices.md"                      -> (13, 0, 0),
